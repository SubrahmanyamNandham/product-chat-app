...
__decorate([
    (0, mongoose_1.Prop)({ enum: ['open', 'closed'], default: 'open' }),
...
], Conversation.prototype, "unreadCountForAgent", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: 0 }),
    __metadata("design:type", Number)
], Conversation.prototype, "unreadCountForCustomer", void 0);
exports.Conversation = Conversation = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true })
], Conversation);
exports.ConversationSchema = mongoose_1.SchemaFactory.createForClass(Conversation);
exports.ConversationSchema.index({ customerId: 1, productId: 1 }, { unique: true });
